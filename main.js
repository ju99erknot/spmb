      ...
      if (formCard) {
        formCard.innerHTML = `
          <div style="text-align:center; padding:30px 10px; animation: slideUp 0.5s ease;">
            ...
            <div style="font-size:24px; font-weight:800; color:#c53030; margin-bottom:10px; letter-spacing:-0.5px;">
                PENDAFTARAN DITUTUP
            </div>
            
            <p style="color:#4a5568; margin-bottom:25px; font-size:15px; line-height:1.5;">
              Mohon maaf, kuota pendaftaran di <b>SDN 02 CIBADAK</b> sudah terpenuhi (${maxKuota} Siswa).
            </p>
            
            <div style="background:#fff5f5; padding:20px; border-radius:16px; text-align:left; border:1px solid #feb2b2; position:relative; overflow:hidden;">
              <div style="display:flex; align-items:center; gap:8px; margin-bottom:8px;">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#c53030" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 5L6 9H2v6h4l5 4V5z"></path><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                <b style="color:#c53030; font-size:14px; text-transform:uppercase; letter-spacing:0.5px;">Info Panitia</b>
              </div>
              
              <p style="font-size:13px; color:#4a5568; line-height:1.6; margin:0;">
                Bapak/Ibu yang belum sempat mendaftar secara online dapat menghubungi Panitia via WhatsApp untuk informasi lebih lanjut mengenai status pendaftaran atau bantuan lainnya.
              </p>
